...
ITEM_KIND = {
    ...
    "2.02": "실적 발표",
    "2.03": "채무 발생",
    # 3.01 은 규정 미달 통보(예: 이사 공석으로 위원회 인원 부족)·상장폐지·거래소 이전을 다 포함한다.
    #   '상장폐지' 로만 적으면 실제보다 무섭게 보인다 (UI 2025-12 는 이사 별세로 인한 형식상 미달)
    "3.01": "상장 요건 미달·거래소 이전 (원문 확인)",
    "3.02": "미등록 주식 발행",
    "4.01": "회계법인 변경",
    "4.02": "과거 재무제표 신뢰 불가",
    "5.02": "임원 선임·사임",
...
FILING_KIND = {
    ...
    # 13D = 단순투자가 아닌 5% 이상 주주. 행동주의만이 아니라 창업자·CEO 도 낸다
    #   (DAVE 2026-09 는 CEO 의 선불 선도계약 — 사실상 일부 매도)
    "SC 13D": "5% 이상 보유 (단순투자 아님 — 창업자·경영진·행동주의)",
    "SC 13G": "5% 이상 취득 (단순투자)",
    "4":     "임원·대주주 매매",
    "3":     "임원·대주주 최초 보고",
    "5":     "임원·대주주 연간 보고",
    "144":   "대주주 매도 예정 신고",
    "SC 13D/A": "5% 이상 보유 변경 (단순투자 아님 — 원문 확인)",
    "SC 13G/A": "5% 취득 변경 (단순투자)",
    "SCHEDULE 13G/A": "5% 이상 보유 변경 (단순투자)",
    "SCHEDULE 13D/A": "5% 이상 보유 변경 (단순투자 아님 — 원문 확인)",
    "SCHEDULE 13G": "5% 이상 보유 (단순투자)",
    "SCHEDULE 13D": "5% 이상 보유 (단순투자 아님 — 창업자·경영진·행동주의)",
    "8-K/A": "수시공시 수정본",
    "10-Q/A": "분기보고서 수정본",
    "10-K/A": "연간보고서 수정본",
    "11-K":  "임직원 주식매입제도 보고",
